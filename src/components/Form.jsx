...
export function LoginForm() {
  ...
  const onLogin = async (e) => {
    ...
    try {
      ...
      setOpen(true);
      const loginRequest = await axios.post('https://final-project-backend-diaz.herokuapp.com/auth/login', userToLoginPayload);
...
export function RegisterForm() {
  ...
  const onRegister = async (e) => {
    ...
    try {
      ...
      const registerRequest = await axios.post('https://final-project-backend-diaz.herokuapp.com/auth/register', userToRegisterPayload);
...
export function InfoAccForm() {
  ...
  const onUpdate = async (e) => {
    ...
    try {
      ...
      const createRequest = await axios.put(`https://final-project-backend-diaz.herokuapp.com/users/update/${id}`, createPostPayload, {
        headers: {
...
export function InfoProductForm(props) {
  ...
  const onCreate = async (e, isPublish) => {
    ...
    try {
      ...
      const createRequest = await axios.post('https://final-project-backend-diaz.herokuapp.com/products/create', createPostPayload, {
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'multipart/form-data',
        },
...
export function UpdateProductForm(props) {
  ...
  const onUpdate = async (e, isPublish) => {
    ...
    try {
      ...
      setOpen(true);
      const createRequest = await axios.put(`https://final-project-backend-diaz.herokuapp.com/products/${id}`, createPostPayload, {
        headers: {
          Authorization: `Bearer ${token}`,
          'Content-Type': 'multipart/form-data',
        },
