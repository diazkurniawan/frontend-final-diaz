...
export function Offer() {
  ...
  const getTransaksiById = async () => {
    try {
      ...
      const responseProduct = await axios.get(`https://final-project-backend-diaz.herokuapp.com/transactions/${id}`, {
        headers: {
  ...
  const updateTransaction = async (e, isAccepted, isRejected, isOpened) => {
    ...
    try {
      ...
      const token = localStorage.getItem('token');
      const transactionRequest = await axios.put(`https://final-project-backend-diaz.herokuapp.com/transactions/${id}`, updateTransaction, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const updateStatus = async (e) => {
    ...
    try {
      ...
      const token = localStorage.getItem('token');
      const statusRequest = await axios.put(`https://final-project-backend-diaz.herokuapp.com/transactions/${id}`, payloadUpdateStatus, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
