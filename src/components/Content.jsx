  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const currentUserRequest = await axios.get('https://final-project-backend-diaz.herokuapp.com/auth/me', {
          headers: {
        ...
        if (currentUserResponse.data.user.id) {
          const dataTransaction = await axios.get(`https://final-project-backend-diaz.herokuapp.com/transactions/seller/${currentUserResponse.data.user.id}`, {
            headers: {
              Authorization: `Bearer ${token}`,
            },
          });
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        if (currentUserResponse.data.user.id) {
          const dataTransaction = await axios.get(`https://final-project-backend-diaz.herokuapp.com/transactions/user/${currentUserResponse.data.user.id}`, {
            headers: {
              Authorization: `Bearer ${token}`,
            },
          });
...
export function UserProfile() {
  ...
  const getProduct = async () => {
    try {
      const token = localStorage.getItem('token');
      const responseProduct = await axios.get(`https://final-project-backend-diaz.herokuapp.com/products/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const onUpdateById = async (e, isPublish) => {
    ...
    try {
      ...
      const createRequest = await axios.put(`https://final-project-backend-diaz.herokuapp.com/products/${id}`, postPayload, {
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  const onCreateTransaction = async (e, isOpened, isRejected, isAccepted) => {
    ...
    try {
      ...
      setShow(false);
      const createRequest = await axios.post('https://final-project-backend-diaz.herokuapp.com/transactions', postPayload, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      ...
      const responseTransactionByUserId = await axios.get(`https://final-project-backend-diaz.herokuapp.com/transactions/user/${userId.id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
